"""
Hill Climbing Ensemble: v4+++TT + DART (Kaggle GPU)
- v4+++TT (18 models) + Ridge→LGB DART = 19 models
...
DATA_DIR_3 = Path("/kaggle/input/datasets/nyhalcyon/dart-oof-predictions")
OUTPUT_DIR = Path("/kaggle/working")

# v4+++TT (18 models) + DART = 19 models
MODELS = {
    ...
    "ridge_lgbm_dart":          "20260331_13_ridge_lgbm_dart",
}
...
def main():
    print("=" * 70)
    print("Hill Climbing: v4+++TT + DART (19 models)")
    print("=" * 70)
