"""
XGBoost max_depth=1
Experiment: 20260313_04_xgboost_depth1

目的: max_depth=1でのXGBoost実験。Discussion知見: 元データの特徴量が独立的なためdepth=1が最適
アプローチ: Label Encoding + XGBoost (max_depth=1) + Charge_Difference特徴量
"""
...
def extract_features(train_df, test_df):
    ...
    XGBoost handles encoded categoricals well with hist tree method.
    """
