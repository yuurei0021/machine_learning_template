...
class CFG:
    ...
    # Ridge predictions from experiment 05
    RIDGE_OOF = BASE_DIR.parent / "20260328_05_ridge_nb1feat_oof" / "predictions" / "oof.csv"
    RIDGE_TEST = BASE_DIR.parent / "20260328_05_ridge_nb1feat_oof" / "predictions" / "test_proba.csv"
...
def load_ridge_predictions():
    ...
    ridge_oof = pd.read_csv(CFG.RIDGE_OOF)
    ridge_test = pd.read_csv(CFG.RIDGE_TEST)
