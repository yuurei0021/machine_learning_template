"""
Stacking XGBoost: raw features + TabM/RealMLP/Ridge OOF predictions
Experiment: 20260331_03_stacking_xgb
...
XGBoost with default parameters, 5-fold CV.
"""
...
def main():
    ...
    print("=" * 60)
    print("Stacking XGBoost: raw features + TabM/RealMLP/Ridge predictions")
    print("=" * 60)
    ...
    for fold, (tr_idx, va_idx) in enumerate(skf.split(X_train, y)):
        ...
        if fold == 0:
            ...
            imp_sorted = sorted(imp.items(), key=lambda x: -x[1])[:10]
            print(f"\n  Top features (gain):")
