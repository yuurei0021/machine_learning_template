"""
Hill Climbing Ensemble v3
Experiment: 20260327_09_hillclimb_ensemble_v3

v2 + Logit3 TE-Pair LogReg, ExtraTrees, XGB Optuna 20-fold.
Pruned to 13 models (removed duplicates and low-AUC models).
"""
...
def main():
    print("=" * 70)
    print("Hill Climbing Ensemble v3 (13 pruned models)")
    print("=" * 70)
