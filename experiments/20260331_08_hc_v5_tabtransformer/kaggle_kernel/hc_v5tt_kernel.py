"""
Hill Climbing Ensemble: v5 + TabTransformer (Kaggle GPU)
- v5 model set (20 models) + TabTransformer = 21 models
...
def main():
    print("=" * 70)
    print("Hill Climbing: v5 + TabTransformer (21 models)")
    print("=" * 70)
